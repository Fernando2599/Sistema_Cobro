        ...
        <a class="nav-item nav-link active" href="#" aria-current="page">
            ...
            <?php if (isset($_SESSION['rol_id'])): ?>
                <?php if ($_SESSION['rol_id'] == '1'): ?>
                    ...
                    <a class="nav-item nav-link <?= ($_GET['controlador'] ?? '') === 'ventas' && ($_GET['accion'] ?? '') === 'crear' ? 'active' : '' ?>" href="?controlador=ventas&accion=crear">Venta</a>
                    <a class="nav-item nav-link <?= ($_GET['controlador'] ?? '') === 'cortes' && ($_GET['accion'] ?? '') === 'crear' ? 'active' : '' ?>" href="?controlador=cortes&accion=crear">Corte</a>
                    ...
                    <a class="nav-item nav-link <?= ($_GET['controlador'] ?? '') === 'depositos' && ($_GET['accion'] ?? '') === 'crear' ? 'active' : '' ?>" href="?controlador=depositos&accion=crear">Depositos</a>
                    <a class="nav-item nav-link <?= ($_GET['controlador'] ?? '') === 'depositos' && ($_GET['accion'] ?? '') === 'reportes' ? 'active' : '' ?>" href="?controlador=depositos&accion=reportes">Reportes</a>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a class="nav-item nav-link <?= ($_GET['controlador'] ?? '') === 'iniciar' && ($_GET['accion'] ?? '') === 'login' ? 'active' : '' ?>" href="?controlador=iniciar&accion=login">Iniciar Sesión</a>
            <?php endif; ?>
        </div>
    </nav>
