        ...
        <a class="nav-item nav-link active" href="#" aria-current="page">
            ...
            <?php if (isset($_SESSION['rol_id'])): ?>
                <?php if ($_SESSION['rol_id'] == '1'): ?>
                    ...
                    <a class="nav-item nav-link <?= ($_GET['controlador'] ?? '') === 'clientes' && ($_GET['accion'] ?? '') === 'inicio' ? 'active' : '' ?>" href="?controlador=periodos&accion=ActualizarMonto"><i class="bi bi-people-fill"></i> Actualizar monto</a>
